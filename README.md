...
|--------------------------------------------------------------------------------|-----------------------------------------------------------------------------------|-----------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Amazon Reference ID<br>or Amazon OrderReference ID/Amazon Billing Agreement ID | `amazon_reference_id`<br>`amazon_order_reference_id`/`amazon_billing_agrement_id` | yes       | `Amazon Reference ID` can be OrderReference ID (`starts with P01 or S01`) or <br>Billing Agreement ID (`starts with B01 or C01`)<br>If key `Amazon Reference ID` is not used either `amazon_order_reference_id`/`amazon_billing_agreement_id` should be provided|

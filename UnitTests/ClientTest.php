...
class ClientTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testConfigArray()
    {
        try {
            ...
            $client = new Client($this->_ConfigParams);
    ...
    public function testGetOrderReferenceDetails()
    {
        ...
        $parameters = $this->_setParametersAndPost($fieldMappings,$action);
    ...
    private function _setParametersAndPost($fieldMappings,$action)
    {
